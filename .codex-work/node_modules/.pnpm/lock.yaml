...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz':
    resolution: {integrity: sha512-ZD5qmg7isEqCcdluRI0+xpQ7mYUSuGJlB7vMB/0E/kjc7G4ZjilfEKCxtUQYuU1qEvpnv53eRSaMrBGrKwTnvA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz}
    version: 2.7.8
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
