  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.98
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.2.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.2.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.2.tgz':
    resolution: {integrity: sha512-7CKvsx/08R0ZJPYLLeRio7hFD5Jws7CckN9t86lNYjGJsJ5im5zjxTLI+YtvVW2cequT7+3EP82kkwRziTS29Q==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.2.tgz}
    version: 2.7.2
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
