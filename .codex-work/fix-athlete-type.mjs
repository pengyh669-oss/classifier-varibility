...
const inputPath = "转录数据/语音转录.xlsx";
const backupPath = "转录数据/语音转录.backup_before_athlete_fix.xlsx";
const outputDir = "outputs/athlete_fix_20260425";
const fallbackPath = `${outputDir}/语音转录_运动员已修正.xlsx`;
const targetNoun = "运动员";
const targetType = "普通词";
...
for (let i = 1; i < values.length; i += 1) {
  ...
  if (noun === targetNoun && nounType !== targetType) {
...
console.log(JSON.stringify({ changedCount: changed.length, changed, backupPath, savedPath, originalOverwritten }, null, 2));
